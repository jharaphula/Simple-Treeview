...
function Expand() {
   ...
   for (i=0;i<divs.length;i++) {
	 ...
	 key.innerHTML="<img src='img/textfolder.gif' width='16' height='16' hspace='0' vspace='0' border='0'>";
   }
}
...
function Collapse() {
   ...
   for (i=0;i<divs.length;i++) {
	 ...
	 key=document.getElementById("x" + divs[i].id);
	 key.innerHTML="<img src='img/folder.gif' width='16' height='16' hspace='0' vspace='0' border='0'>";
   }
}
